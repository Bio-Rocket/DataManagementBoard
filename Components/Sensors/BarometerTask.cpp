 ...
 */
    ...
    HAL_SPI_Transmit(SystemHandles::BARO_SPI, &RESET_CMD, CMD_SIZE, CMD_TIMEOUT);
    ...
    HAL_GPIO_WritePin(BARO_CS_GPIO_Port, BARO_CS_Pin, GPIO_PIN_RESET);
    HAL_SPI_Transmit(SystemHandles::BARO_SPI, &ADC_D1_512_CONV_CMD, CMD_SIZE, CMD_TIMEOUT);
    HAL_GPIO_WritePin(BARO_CS_GPIO_Port, BARO_CS_Pin, GPIO_PIN_SET);
    ...
    HAL_SPI_Transmit(SystemHandles::BARO_SPI, &ADC_READ_CMD, CMD_SIZE, CMD_TIMEOUT);

    // Read the first byte (bits 23-16)
    HAL_SPI_TransmitReceive(SystemHandles::BARO_SPI, &READ_BYTE_CMD, &dataInBuffer, CMD_SIZE, CMD_TIMEOUT);
    ...
    HAL_GPIO_WritePin(BARO_CS_GPIO_Port, BARO_CS_Pin, GPIO_PIN_RESET);
    HAL_SPI_Transmit(SystemHandles::BARO_SPI, &ADC_D2_512_CONV_CMD, CMD_SIZE, CMD_TIMEOUT);
    HAL_GPIO_WritePin(BARO_CS_GPIO_Port, BARO_CS_Pin, GPIO_PIN_SET);
    ...
    // Read the first byte (bits 23-16)
    HAL_SPI_TransmitReceive(SystemHandles::BARO_SPI, &ADC_READ_CMD, &dataInBuffer, CMD_SIZE, CMD_TIMEOUT);
...
uint16_t BarometerTask::ReadCalibrationCoefficients(uint8_t PROM_READ_CMD)
{
    ...
    HAL_SPI_Transmit(SystemHandles::BARO_SPI, &PROM_READ_CMD, CMD_SIZE, CMD_TIMEOUT);
